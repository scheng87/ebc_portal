  ...
  fluidRow(
    ...
    column(4,
           ...
           wellPanel(
             ...
             h5(div(em("April 12, 2016"),style="color:#FF6633")),
             p("Working group's systematic map on impact of nature conservation on human well-being accepted in Environmental Evidence. ",a("Read here",href="https://environmentalevidencejournal.biomedcentral.com/articles/10.1186/s13750-016-0058-7")),
             h5(div(em("February 28, 2016"),style="color:#FF6633")),
             p("Productive first working group meeting of SNAPP Phase II! Discussing plans for improving the search for evidence, the generation of evidence, and the use of evidence for conservation decision-making. ",a("Read more here",href="http://snappartnership.net/groups/evidence-based-conservation/"))
           )
           ),
    column(4,
           ...
           wellPanel(
             ...
             p(strong("Projected timeline:")," Present-end 2016"),
             ...
             p(strong("Projected timeline:")," Present-September 2016")
           )
           )
  ),
  fluidRow(

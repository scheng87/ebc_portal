...
shinyUI(
  fluidPage(
      ...
      tags$head(tags$style(".banner_portal{height:225px;background-image: url('header2_test.png');background-repeat: no-repeat}")),
      ...
      column(12,
             div(class="banner_portal",style="padding:20px 20px 20px 20px",
                 column(8,
                        align="left",
                        br(),
                        h1(div(strong("EVIDENCE FOR NATURE AND PEOPLE"),style="color:#f9cc0f;font-size:45px")),
                        p(div(em("DATA PORTAL"),style="color:#f9cc0f;font-size:35px"))
                        ),
                 column(4,
                        align="right",
                        br(),
                        br(),
                        a(img(src="snap-acronym-color-white.png",height=75),href="http://snappartnership.net/"),
                        br()
                 )
               )
      )
    ...
    navbarPage("",
      ...
      navbarMenu("EXPLORE BY:",
                ...
                tabPanel("Region/Country Summaries",
                         eregi()
                         ),
                tabPanel("Biome",
                         ebiom()

...
map_data_final <- map_data_final[c("aid","Pub_type","Authors","Pub_year","Title","Journal","int_group","Int_type","Outcome","Study_location","Study_country","subregion","region","Biome.","biome_group","IE","study_type","Comps","Comps.type","Comps.time","Design.qual_only","Design.assigned","Design.control","DOI","Title.formatted","Fullcitation","FullText")]
...
Study_location <- select(data.study,aid,Study_location) %>% distinct()
map_data_final2 <- left_join(map_data_final,Study_location,by="aid") %>% distinct()
map_data_final <- map_data_final2

      ...
      column(8,
             ...
             tabsetPanel(
               ...
               tabPanel("The Tool",
                        ...
                        p("As this tool is designed to help users find and explore usable data, feedback would be very much appreciated on functionality and utility. Please see the ",span(strong("CONTACT"),style="color:#006666")," tab to fill out a feedback form or you can directly email the postdoctoral fellow, Samantha Cheng at ",a("cheng@nceas.ucsb.edu",href="cheng@nceas.ucsb.edu"),"."),
                        p("For any questions or comments, please contact the project leads, ",a("Madeleine McKinnon",href="mcmckinno@conservation.org"), " and ", a("David Wilkie",href="dwilkie@wcs.org"),". For any questions or comments on this tool, please contact the postdoctoral fellow, ",a("Samantha Cheng",href="cheng@nceas.ucsb.edu"),"."),
                        br(),
